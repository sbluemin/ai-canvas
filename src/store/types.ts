import { AiProvider, Attachment, ModelInfo, AvailableModels, SelectedModels, WritingGoal, WritingGoalPreset } from '../types/chat';

export type { AiProvider, Attachment, ModelInfo, AvailableModels, SelectedModels, WritingGoal, WritingGoalPreset };
...
export interface ChatSlice {
  ...
  addMessage: (role: 'user' | 'assistant', content: string, provider?: AiProvider, attachments?: Attachment[]) => void;
